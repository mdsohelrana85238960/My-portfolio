...
<div className="text-center mt-32 mb-16">
       <h1 className="text-4xl my-2 font-medium text-white"> Project</h1> 
            ...
            <div>
                ...
                <div className="md:flex justify-center items-center gap-12">
                    <img className="w-[550px]" src="https://i.ibb.co/FnFHGDw/Screenshot-2023-12-11-210215.png" alt="" />
                    <div>
                        <h1 className="text-3xl font-medium">Library management</h1>
                        <p className="py-2 font-bold text-xl">Projects Overview</p>
                        <li>My website is a library management system through my website so a user can pick up and bring or return books.</li>
                        <li> In this project, In order to get a book, a user must first register and then login.</li>
                        <li>We applied JWT, Firebase authentication.</li>
                ...
                <div className="md:flex justify-center items-center gap-12 my-20 ">
                    ...
                    <div>
                        <h1 className="text-3xl font-medium">Shoe Store</h1>
                        <p className="py-2 font-bold text-xl">Projects Overview</p>
